...
while abs(angle) > 0.3 :
  ...
  # path 
  path =filename    #r'/home/niryo/catkin_ws/src/niryo_one_python_api/examples/testImage.jpg' #A voir si nécessaire
...
n.activate_learning_mode(False) #Est ce nécessaire
